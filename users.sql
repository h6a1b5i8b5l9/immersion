...
CREATE TABLE `users` (
  ...
  `telegram` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`, `role`, `email`, `password`, `name`, `avatar`, `position`, `telephone`, `address`, `status`, `vk`, `telegram`, `instagram`) VALUES
